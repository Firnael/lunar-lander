        ...
        <main className="howtoplay-main-container">
            ...
            <section className="section">
                <aside className="menu">
                    <p className="menu-label">Sommaire</p>
                    <ul className="menu-list">
                        ...
                        <li>
                            <a href="#gameplay">Comment jouer 🕹️</a>
                        </li>
                        <li>
                ...
                <div className="content">
                    <div className="columns">
                        <div className="column">
                            <div className="block">
                                Vous pouvez (et êtes même encouragé) à customiser votre vaisseau en modifiant
                                les variables se trouvant au début de <code>app.ts</code> :
                            </div>
                            <div className="block">
                                <pre>
                                    <code>
                            ...
                            <div className="block">
                                <ul>
                                    <li>
                                        ...
                                        <br/>
                                        Votre pseudo, s'affiche au dessus de votre vaisseau, ainsi que dans le classement.
                                        <br/>
                                    ...
                                    <li>
                                        ...
                                        <br/>
                                        Votre couleur, s'affiche autour de votre vaisseau, et derrière votre pseudo en tout temps.
                                        <br/>
                                        Pensez à <strong>retirer le <code>#</code></strong> de votre couleur, ne gardez que les charactères hexa
                                    </li>
                                </ul>
                            </div>
                            <div className="block">
                                (vous pouvez aussi fournir ces valeurs via des <strong>variables d'environnement</strong>)
                            </div>
                        </div>
                        <div className="column">
                            <p>Un clic sur une couleur ou un emoji le place dans votre presse-papier,
                                il ne vous reste plus qu'à le coller dans votre code !</p>
                            <div className="block">
                                <br/>
            ...
            <section className="section" id="rules">
                <div className="content">
                    ...
                    <div className="block">
                        ...
                        <br/>
                        Un pictogramme <span className="tag is-danger">⚠️</span> s'affichera à partir du moment où votre vaisseau sera <strong>en danger</strong> :
                        <ul>
                    ...
                    <div className="block">
                        ...
                        <p>
                            ...
                            et sans carburant, il devient incontrôlable, et part à la dérive (ce qui n'est jamais bon !).
                            <br/>
                            Cette limite est de <strong>{ serverConfig.FUEL_TANK_SIZE }</strong> unités.
                            <br/>
                            <br/>
